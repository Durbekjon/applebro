const services = [
  {
    ...
    description: 'С помощью Apple Trade In вы можете получить большую выгоду за свое текущее устройство и использовать ее для покупки нового. И вы можете сделать все это онлайн или в AppleBro Store. Если ваше устройство не подходит для кредита, мы утилизируем его бесплатно. Это выгодная сделка для вас и планеты.',
    isPurple: true,
  },
  {
    title: 'Гибкая оплата',
  ...
  {
    title: 'Гарантия',
    description: 'При покупке устройства Apple в AppleBro вы получаете 2 года гарантийного обслуживания.',
    isPurple: false,
  },
];
