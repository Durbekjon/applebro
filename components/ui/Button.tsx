...
export default function Button({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-purple-600 to-purple-500 text-white  rounded-full hover:from-purple-700 hover:to-purple-600 shadow-lg shadow-purple-500/30',
